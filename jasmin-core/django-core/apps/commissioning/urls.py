...
urlpatterns = [
    ...
    path(
        "share_type_variation_amounts_for_planning/",
        ShareTypeVariationAmountsForPlanningView.as_view(),
        name="share_type_variation_amounts_for_planning",
    ),
    path(
        "member_growth_statistics/",
        member_growth_statistics,
    ...
    path(
        "historical_share_type_variation_averages/",
        historical_share_type_variation_averages,
        name="historical_share_type_variation_averages",
    ),
    path(
        "orders_overview/",
