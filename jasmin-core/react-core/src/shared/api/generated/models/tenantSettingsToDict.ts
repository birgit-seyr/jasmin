...
import type { TenantSettingsToDictUsedTiersForOffers } from './tenantSettingsToDictUsedTiersForOffers';
 ...
 */
export interface TenantSettingsToDict {
  /** @nullable */
  early_payment_discount_percent: number | null;
  default_tax_rate_articles: number;
  default_tax_rate_crates: number;
  default_tax_rate_shares: number;
  ...
  /** @nullable */
  used_tiers_for_offers?: TenantSettingsToDictUsedTiersForOffers;
